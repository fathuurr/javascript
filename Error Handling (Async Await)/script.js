...
//   fetch('http://www.omdbapi.com/?apikey=135f5aaa&s=' + inputKeyword.value)
...
//           fetch('http://www.omdbapi.com/?apikey=135f5aaa&i=' + imdbid)
//             .then((response) => response.json())
//             .then((m) => {
//               const movieDetail = showMovieDetail(m);
...
function getMovies(keyword) {
  return fetch('http://www.omdbapi.com/?apikey=135f5aaa&s=' + keyword)
    .then((response) => {
      if (!response.ok) {
...
function getMovieDetail(imdbid) {
  return fetch('http://www.omdbapi.com/?apikey=135f5aaa&i=' + imdbid)
    .then((response) => response.json())
    .then((m) => m);
}
